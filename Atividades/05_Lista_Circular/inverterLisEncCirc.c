...
void inverter(LISTA *l)
{
    ...
    NO *pAnterior = l->cabeca, *pAtual = pAnterior->prox, *pAnteriorAnterior = l->cabeca;
    int i;
    ...
    for (i = 0; i < tamanho(l); i++)
    {
        ...
        pAnterior = pAtual;
        pAtual = pAtual->prox;
        pAnterior->prox = pAnteriorAnterior;
        pAnteriorAnterior = pAnterior;
        if (pAtual->prox == l->cabeca)
        {
